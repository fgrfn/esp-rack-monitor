...
Wenn das leere Repo `fgrfn/esp-rack-monitor` existiert:

```bash
git init
git branch -M main
git add .
git commit -m "Initial ESP Rack Monitor ESPHome config"
git remote add origin git@github.com:fgrfn/esp-rack-monitor.git
